package be.ucll.introduction.bugsolve;
...
public class NumberToText {
	...
	// so quintillions is as big as it gets. The program would automatically handle larger numbers if this array were extended.
	...
	public static void main(String[] args) {
		...
		System.out.println(numberToText.numberToText(155));
	}
