...
public class Exercise4 {
	...
	public void testFilterPersons() {
		...
		// http://docs.oracle.com/javase/8/docs/api/java/util/stream/Stream.html If you successfully filter the persons,
		// the test will succeed. You must only use one (1) line of code which will be possible if using the Stream API!

		// todo add your single line of code here to filter "data", if the line is correct the test below will succeed
	...
	public void testAverageAgeOnFilteredPersonsUsingJavaStreams() {
		...
		double averageAge = 0; // todo add you code here, remove the "= 0" assignment of course with the stream result, if the code is correct the test will succeed
